...
](#testing-with-pytest-fixtures)Testing with Pytest Fixtures
...
The [FastMCP Repository contains thousands of tests](https://github.com/PrefectHQ/fastmcp/tree/main/tests) for the FastMCP Client and Server. Everything from connecting to remote MCP servers, to testing tools, resources, and prompts is covered, take a look for inspiration![Project Configuration
Previous](/deployment/server-configuration)[OpenTelemetry
Next](/servers/telemetry)⌘I
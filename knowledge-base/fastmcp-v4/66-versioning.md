...
](#versioned-api-surfaces)Versioned API Surfaces
...
](#filtering-mounted-servers)Filtering Mounted Servers
...
](#versioned-vs-unversioned-components)Versioned vs Unversioned Components
...
Tool Call Request ParamsPrompt Request Params
...
](#retrieving-specific-versions)Retrieving Specific Versions
...
```
[Background Tasks
Previous](/servers/tasks)[Authentication
Next](/servers/auth/authentication)⌘I